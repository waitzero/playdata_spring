				...
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
                            ...
                            <div class="app_content email_area">
                                <input type="text" name="writer" placeholder="작성자" readonly="readonly" value="${vo.writer}"/>
						...
						<li class="clear">
							...
							<div class="app_content">
								<input type="text" name="title" class="w100p" id="name_lbl" placeholder="제목을 입력하세요" required="required" value="${vo.title}"/>
							</div>
						</li>
