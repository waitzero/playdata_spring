					...
					<ul class="app_list">
                        <li class="clear">
                            ...
                            <div class="app_content email_area">
                            	<!-- required, pattern속성을 사용할 때는 form태그를 반드시 submit버튼으로 전송해야 동작 -->
                                <input type="text" name="tripdate" id="datepicker_a" placeholder="날짜를 선택하세요" required="required" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" ></p>
                            </div>
						</li>
