<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">
			<!-- appForm -->
			<form action="noticeUpdate" method="post" class="appForm">
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
                            ...
                            <div class="app_content email_area">
                                <input type="text" name="writer" name="${vo.writer}"placeholder="작성자" readonly="readonly"/>
						...
						<li class="clear">
							...
							<div class="app_content">
								<input type="text" name="title" name="${vo.title }"class="w100p" id="name_lbl" placeholder="제목을 입력하세요" required="required"/>
							</div>
						</li>
						...
						<li class="clear">
							...
							<div class="app_content">
							<textarea name="content" name="${vo.content}"id="content_lbl" class="w100p"></textarea>
							</div>
						</li>
					</ul>
					<p class="btn_line">
